...
$server = "SQUAREPEG"
$database = "HMIS"
$viewListPath = "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\LSA Utilities\HICViewList.csv"

# Read the view/output pairs
$views = Import-Csv -Path $viewListPath -Header ViewName,OutputFile

Remove-Item -Path "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\Sample Data\Sample HIC Temp Tables\*" -Force
Remove-Item -Path "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\Sample Data\Sample HIC Output\*" -Force
...
Compress-Archive -Path "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\Sample Data\Sample HIC Temp Tables\*.*" -Update "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\Sample Data\Sample HIC Temp Tables.zip" 
Compress-Archive -Path "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\Sample Data\Sample HIC Output\*.*" -Update "C:\Users\MollyMcEvilley\OneDrive - Square Peg Data\GitHub\LSASampleCodev8\Sample Data\Sample HIC Output.zip"
